  ...
  <footer id="footer">
      <div class="container">
          <div class="row">
              <div class="col-md-3">
                  <a href="index.html"><img src="{{ asset('asset/logo.svg') }}"
                  ...
                  <div class="address">
                      ...
                      <div class="address-links">
                          <li class="address1"><i class="fa-solid fa-location-dot">
                                  <a href="">
                                    Jl. Ambarawa No.5, Sumbersari, Kec. Lowokwaru, Kota Malang, Jawa Timur 65145</a>
                              </i>
                          </li>
                          <li><a href="">
  ...
  <section id="copy-right">
      <div class="copy-right-sec"><i class="fa-solid fa-copyright"></i>
        2024 All rights reserved.  <a href="#">This is Your Company</a>
